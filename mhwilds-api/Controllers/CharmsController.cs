...
namespace mhwilds_api.Controllers
{
    ...
    public class CharmsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAll()
        {
            ...
            var response = charms.Adapt<List<CharmResponse>>();
        ...
        [HttpPost]
        public async Task<IActionResult> Create(List<Charm> charms)
        {
            if (charms == null || charms.Count == 0)
                return BadRequest("No charms found.");
            ...
            try
            {
                ...
                var response = createdCharmsWithIds.Adapt<List<CharmResponse>>();
                return Ok(response);
            }
