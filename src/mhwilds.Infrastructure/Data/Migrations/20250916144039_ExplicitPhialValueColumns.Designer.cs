...
namespace mhwilds.Infrastructure.Migrations
{
    ...
    [Migration("20250916144039_ExplicitPhialValueColumns")]
    partial class ExplicitPhialValueColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Armour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Charm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.CharmRank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Decoration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Skill", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.SkillRank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.BaseWeapon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.ChargeBlade", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");

                    b.HasDiscriminator().HasValue(8);
                });

            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.DualBlades", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.Greatsword", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.Gunlance", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.Hammer", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.HuntingHorn", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.InsectGlaive", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.Lance", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.Longsword", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.SwitchAxe", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.SwordAndShield", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Ranged.Bow", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Ranged.HeavyBowgun", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Ranged.LightBowgun", b =>
                {
                    b.HasBaseType("mhwilds.Domain.Entities.Weapons.BaseWeapon");
            ...
            modelBuilder.Entity("ArmourSkillRank", b =>
                {
                    b.HasOne("mhwilds.Domain.Entities.Armour", null)
                        .WithMany()
                        .HasForeignKey("ArmoursId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("mhwilds.Domain.Entities.SkillRank", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BaseWeaponSkillRank", b =>
                {
                    b.HasOne("mhwilds.Domain.Entities.Weapons.BaseWeapon", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CharmRankSkillRank", b =>
                {
                    b.HasOne("mhwilds.Domain.Entities.CharmRank", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DecorationSkillRank", b =>
                {
                    b.HasOne("mhwilds.Domain.Entities.Decoration", null)
                        .WithMany()
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Armour", b =>
                {
                    b.OwnsOne("mhwilds.Domain.Entities.Resistances", "Resistances", b1 =>
                        {
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.CharmRank", b =>
                {
                    b.HasOne("mhwilds.Domain.Entities.Charm", "Charm")
                        .WithMany("Ranks")
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.SkillRank", b =>
                {
                    b.HasOne("mhwilds.Domain.Entities.Skill", "Skill")
                        .WithMany("Ranks")
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.BaseWeapon", b =>
                {
                    b.OwnsOne("mhwilds.Domain.Entities.Weapons.Common.Damage", "Damage", b1 =>
                        {
                    ...
                    b.OwnsOne("mhwilds.Domain.Entities.Weapons.Common.Element", "Element", b1 =>
                        {
                            b1.Property<int>("BaseWeaponId")
                                .HasColumnType("integer");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.ChargeBlade", b =>
                {
                    b.OwnsOne("mhwilds.Domain.Entities.Weapons.Phial", "Phial", b1 =>
                        {
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Melee.Gunlance", b =>
                {
                    ...
                    b.OwnsOne("mhwilds.Domain.Entities.Weapons.Shell", "Shell", b1 =>
                        {
                            b1.Property<int>("GunlanceId")
                                .HasColumnType("integer");
                    ...
                    b.OwnsOne("mhwilds.Domain.Entities.Weapons.Phial", "Phial", b1 =>
                        {
                            ...
                            b1.Property<string>("Type")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("SA_Phial");

                            b1.Property<int?>("Value")
                                .HasColumnType("integer")
                                .HasColumnName("SA_PhialValue");
            ...
            modelBuilder.Entity("mhwilds.Domain.Entities.Weapons.Ranged.HeavyBowgun", b =>
                {
                    b.OwnsMany("mhwilds.Domain.Entities.Weapons.Common.Ammo", "Ammo", b1 =>
                        {
