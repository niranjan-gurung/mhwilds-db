        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Shell_Type = table.Column<int>(type: "integer", nullable: true),
                    Shell_Power = table.Column<int>(type: "integer", nullable: true),
                    KinsectLevel = table.Column<int>(type: "integer", nullable: true),
                    SwitchAxe_Phial = table.Column<int>(type: "integer", nullable: true),
                    Coatings = table.Column<string[]>(type: "text[]", nullable: true),
